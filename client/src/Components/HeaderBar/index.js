...
function HeaderBar({match}){
    ...
    const staffNav = [
      {id: 6, path: `${match.path}/staff/home`, icon: AiFillHome, text: 'Home'},
      {id: 1, path: `${match.path}/staff/profile`,  icon: ImProfile, text: 'Your Profile' },
      {id: 2, path: `${match.path}/staff/addLeads`,  icon: BiCarousel, text: 'Leads View' },
      {id: 3, path: `${match.path}/staff/addUsers`,  icon: MdUpdate, text: 'Users Panel' },
      {id: 4, path: `${match.path}/staff/contact`,  icon: BsFillChatSquareDotsFill, text: 'Profile' },
      {id: 5, path: `${match.path}/staff/feedback`,  icon: MdFeedback, text: 'Profile' },
      {id: 7, path: `${match.path}/staff/users`,  icon: FaUsers, text: 'Profile' }
    ]

    const supervisorNav = [
      {id: 1, path: `${match.path}/supervisor/home`, text: 'Dashboard', icon: AiFillHome},
      {id: 2, path: `${match.path}/supervisor/profile`, text: 'Your Profile', icon: FaAddressCard },
      {id: 3, path: `${match.path}/supervisor/users`, text: 'Users', icon: FaUsers }
    ]
